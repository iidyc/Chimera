...
#define GPU_MVR_ACCUM_FIELD(name) dst.name += src.name
    GPU_MVR_ACCUM_FIELD(total_search_time_ms);
    GPU_MVR_ACCUM_FIELD(search_wall_ms);
    GPU_MVR_ACCUM_FIELD(stage1_time_ms);
    GPU_MVR_ACCUM_FIELD(s1_cagra_ms);
    GPU_MVR_ACCUM_FIELD(s1_expansion_ms);
    GPU_MVR_ACCUM_FIELD(s1_binary_ip_ms);
    GPU_MVR_ACCUM_FIELD(s1_atomic_agg_ms);
    GPU_MVR_ACCUM_FIELD(s1_sum_scores_ms);
    GPU_MVR_ACCUM_FIELD(s1_topk_sort_ms);
    GPU_MVR_ACCUM_FIELD(s1_d2d_ms);
    GPU_MVR_ACCUM_FIELD(s1_memset_ms);
    GPU_MVR_ACCUM_FIELD(s1_sum_accounted_ms);
    GPU_MVR_ACCUM_FIELD(phase_a_wall_ms);
    GPU_MVR_ACCUM_FIELD(phase_a_gpu_total_ms);
    GPU_MVR_ACCUM_FIELD(phase_a_gather_ms);
    GPU_MVR_ACCUM_FIELD(phase_a_prefix_ms);
    GPU_MVR_ACCUM_FIELD(phase_a_token_ids_ms);
    GPU_MVR_ACCUM_FIELD(phase_a_d2h_ms);
    GPU_MVR_ACCUM_FIELD(phase_a_cpu_launch_gather_ms);
    GPU_MVR_ACCUM_FIELD(phase_a_cpu_launch_prefix_ms);
    GPU_MVR_ACCUM_FIELD(phase_a_cpu_launch_token_ids_ms);
    GPU_MVR_ACCUM_FIELD(phase_a_cpu_launch_d2h_ms);
    GPU_MVR_ACCUM_FIELD(phase_a_cpu_sync_ms);
    GPU_MVR_ACCUM_FIELD(phase_a_cpu_event_elapsed_ms);
    GPU_MVR_ACCUM_FIELD(phase_a_gpu_sum_accounted_ms);
    GPU_MVR_ACCUM_FIELD(phase_b_wall_ms);
    GPU_MVR_ACCUM_FIELD(phase_b_binary_ip_total_ms);
    GPU_MVR_ACCUM_FIELD(phase_b_doc_score_total_ms);
    GPU_MVR_ACCUM_FIELD(phase_b_total_kernel_ms);
    GPU_MVR_ACCUM_FIELD(phase_c_wait_d2h_ms);
    GPU_MVR_ACCUM_FIELD(phase_c_topk_ms);
    GPU_MVR_ACCUM_FIELD(phase_c_identify_ms);
    GPU_MVR_ACCUM_FIELD(phase_c_gpu_extract_ms);
    GPU_MVR_ACCUM_FIELD(phase_c_cpu_ip_ex_ms);
    GPU_MVR_ACCUM_FIELD(phase_c_wait_extract_ms);
    GPU_MVR_ACCUM_FIELD(phase_c_combine_ms);
    GPU_MVR_ACCUM_FIELD(phase_c_total_ms);
    GPU_MVR_ACCUM_FIELD(phase_c_refined_docs);
    GPU_MVR_ACCUM_FIELD(phase_abc_total_wall_ms);
    GPU_MVR_ACCUM_FIELD(stage2_time_ms);
    GPU_MVR_ACCUM_FIELD(stage3_time_ms);
    GPU_MVR_ACCUM_FIELD(stage3_docs);
    GPU_MVR_ACCUM_FIELD(total_h2d_ms);
    GPU_MVR_ACCUM_FIELD(total_d2h_ms);
    GPU_MVR_ACCUM_FIELD(total_transfer_ms);
    GPU_MVR_ACCUM_FIELD(total_h2d_bytes);
    GPU_MVR_ACCUM_FIELD(total_d2h_bytes);
    GPU_MVR_ACCUM_FIELD(total_transfer_bytes);
#undef GPU_MVR_ACCUM_FIELD
}
...
#define GPU_MVR_AVG_FIELD(name) profile.name /= count
    GPU_MVR_AVG_FIELD(total_search_time_ms);
    GPU_MVR_AVG_FIELD(search_wall_ms);
    GPU_MVR_AVG_FIELD(stage1_time_ms);
    GPU_MVR_AVG_FIELD(s1_cagra_ms);
    GPU_MVR_AVG_FIELD(s1_expansion_ms);
    GPU_MVR_AVG_FIELD(s1_binary_ip_ms);
    GPU_MVR_AVG_FIELD(s1_atomic_agg_ms);
    GPU_MVR_AVG_FIELD(s1_sum_scores_ms);
    GPU_MVR_AVG_FIELD(s1_topk_sort_ms);
    GPU_MVR_AVG_FIELD(s1_d2d_ms);
    GPU_MVR_AVG_FIELD(s1_memset_ms);
    GPU_MVR_AVG_FIELD(s1_sum_accounted_ms);
    GPU_MVR_AVG_FIELD(phase_a_wall_ms);
    GPU_MVR_AVG_FIELD(phase_a_gpu_total_ms);
    GPU_MVR_AVG_FIELD(phase_a_gather_ms);
    GPU_MVR_AVG_FIELD(phase_a_prefix_ms);
    GPU_MVR_AVG_FIELD(phase_a_token_ids_ms);
    GPU_MVR_AVG_FIELD(phase_a_d2h_ms);
    GPU_MVR_AVG_FIELD(phase_a_cpu_launch_gather_ms);
    GPU_MVR_AVG_FIELD(phase_a_cpu_launch_prefix_ms);
    GPU_MVR_AVG_FIELD(phase_a_cpu_launch_token_ids_ms);
    GPU_MVR_AVG_FIELD(phase_a_cpu_launch_d2h_ms);
    GPU_MVR_AVG_FIELD(phase_a_cpu_sync_ms);
    GPU_MVR_AVG_FIELD(phase_a_cpu_event_elapsed_ms);
    GPU_MVR_AVG_FIELD(phase_a_gpu_sum_accounted_ms);
    GPU_MVR_AVG_FIELD(phase_b_wall_ms);
    GPU_MVR_AVG_FIELD(phase_b_binary_ip_total_ms);
    GPU_MVR_AVG_FIELD(phase_b_doc_score_total_ms);
    GPU_MVR_AVG_FIELD(phase_b_total_kernel_ms);
    GPU_MVR_AVG_FIELD(phase_c_wait_d2h_ms);
    GPU_MVR_AVG_FIELD(phase_c_topk_ms);
    GPU_MVR_AVG_FIELD(phase_c_identify_ms);
    GPU_MVR_AVG_FIELD(phase_c_gpu_extract_ms);
    GPU_MVR_AVG_FIELD(phase_c_cpu_ip_ex_ms);
    GPU_MVR_AVG_FIELD(phase_c_wait_extract_ms);
    GPU_MVR_AVG_FIELD(phase_c_combine_ms);
    GPU_MVR_AVG_FIELD(phase_c_total_ms);
    GPU_MVR_AVG_FIELD(phase_c_refined_docs);
    GPU_MVR_AVG_FIELD(phase_abc_total_wall_ms);
    GPU_MVR_AVG_FIELD(stage2_time_ms);
    GPU_MVR_AVG_FIELD(stage3_time_ms);
    GPU_MVR_AVG_FIELD(stage3_docs);
    GPU_MVR_AVG_FIELD(total_h2d_ms);
    GPU_MVR_AVG_FIELD(total_d2h_ms);
    GPU_MVR_AVG_FIELD(total_transfer_ms);
    GPU_MVR_AVG_FIELD(total_h2d_bytes);
    GPU_MVR_AVG_FIELD(total_d2h_bytes);
    GPU_MVR_AVG_FIELD(total_transfer_bytes);
#undef GPU_MVR_AVG_FIELD
}
