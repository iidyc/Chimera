...
chimera_index_v0::chimera_index_v0(
...
void chimera_index_v0::set_doc_mapping(const std::vector<int>& doc_lens) {
...
void chimera_index_v0::allocate_workspace() {
...
size_t chimera_index_v0::doc_len(size_t doc_id) const {
    return doc_ptrs_[doc_id + 1] - doc_ptrs_[doc_id];
}

// ======================== SEARCH PIPELINE ========================

std::vector<size_t> chimera_index_v0::search(const float* queries, size_t k) {
...
void chimera_index_v0::rank_cluster_dists_v0(
...
void chimera_index_v0::rank_all_tokens_1bit_v0(
    int num_candidates,
    size_t k,
...
void chimera_index_v0::rank_all_tokens_exbits_cpu(
