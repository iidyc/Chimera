...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Merge PLAID / ColBERT and gpu_search benchmark tables, compute a joint "
    ...
    parser.add_argument(
        "--profiling-root",
        type=Path,
        default=Path("profiling/experiments/plaid_vs_gpu_search/main/k100"),
    ...
    parser.add_argument(
        ...
        dest="gpu_impls",
        default=[],
        help=f"gpu_search implementation label. Repeatable. Default: {', '.join(DEFAULT_GPU_IMPLS)}",
    )
    parser.add_argument(
        "--colbert-impl",
        action="append",
