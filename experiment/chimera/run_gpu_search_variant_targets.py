...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Benchmark gpu_search and its no-LUT/no-sum variants "
    ...
    parser.add_argument("--output-root", type=Path, default=repo_root / "profiling" / "chimera_variant_targets")
...
def main() -> int:
        ...
        for cfg in configs:
            ...
            for system in systems:
                ...
                rows.append(run_gpu_search_direct(
                    ...
                    extra_row={
                        "experiment": "chimera_variant_targets",
    ...
    if args.dry_run:
        return 0
    results_csv = output_root / f"chimera_variant_targets_results_{args.run_id}.csv"
    summary_csv = output_root / f"chimera_variant_targets_summary_{args.run_id}.csv"
    preferred = [
