...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Run gpu_search at Recall@100 ~= 0.95 while sweeping overlap_chunks. "
    ...
    parser.add_argument("--output-root", type=Path, default=repo_root / "profiling" / "chimera_chunk_sweep")
...
def main() -> int:
    ...
    results_csv = output_root / f"chimera_chunk_sweep_results_{args.run_id}.csv"
    summary_csv = output_root / f"chimera_chunk_sweep_summary_{args.run_id}.csv"
    preferred = [
        "system",
        "dataset",
        "target_recall",
