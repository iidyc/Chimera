...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Run Recall@100 ~= 0.95 ablations for Chimera gpu_search variants. "
    ...
    parser.add_argument("--output-root", type=Path, default=repo_root / "profiling" / "chimera_recall95_ablation")
