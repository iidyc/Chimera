//
// Created by Administrator on 2025/9/22.
//

#ifndef RESIDUALSCALARQUANTIZATIONIGPPIPELINE_HPP
#define RESIDUALSCALARQUANTIZATIONIGPPIPELINE_HPP
...
#pragma omp parallel for default(none) shared(n_vec, code_l, item_vec_l, vec_dim, centroid_l, residual_error_l, centroid_l_py)
    ...
    public:
        ...
        ResidualCodeIGPPipeline() = default;

        ResidualCodeIGPPipeline(const uint8_t* residual_code_l, const float* weight_l,
...
#endif //RESIDUALSCALARQUANTIZATIONIGPPIPELINE_HPP
