...
DATASET_CONFIG_CANDIDATES = {
    "lotte": ("profiling/lotte_config.csv", "profiling/latte_config.csv"),
    "msmarco": ("profiling/msmarco_config.csv",),
    "hotpot": ("profiling/hotpot_config.csv",),
}
...
SYSTEMS = {
    "v6_lite": SystemSpec("v6_lite", "v6_lite", "gpu_search_v6_lite", "v6_lite"),
    "v6_turbo": SystemSpec("v6_turbo", "v6_turbo", "gpu_search_v6_turbo", "v6_turbo"),
    "v6_nolut": SystemSpec("v6_nolut", "v6", "gpu_search_v6_nolut", "v6_nolut"),
    "v6_nosum": SystemSpec("v6_nosum", "v6_nosum", "gpu_search_v6_nosum", "v6_nosum"),
    "v6_nolut_nosum": SystemSpec(
        "v6_nolut_nosum",
        "v6_nolut_nosum",
        "gpu_search_v6_nolut_nosum",
        "v6_nolut_nosum",
    ),
    "v7_lite": SystemSpec("v7_lite", "v7_lite", "gpu_search_v7_lite", "v7_lite"),
    "v7_noalign": SystemSpec("v7_noalign", "v7_unalign", "gpu_search_v7_unalign", "v7_noalign"),
    "v7_unalign": SystemSpec("v7_unalign", "v7_unalign", "gpu_search_v7_unalign", "v7_unalign"),
    "v8": SystemSpec("v8", "v8", "gpu_search_v8", "v8"),
    "v8_nosum": SystemSpec("v8_nosum", "v8_nosum", "gpu_search_v8_nosum", "v8_nosum"),
    "v8_nolut": SystemSpec("v8_nolut", "v8", "gpu_search_v8_nolut", "v8_nolut"),
    "v8_nolut_nosum": SystemSpec(
        "v8_nolut_nosum",
        "v8_nolut_nosum",
        "gpu_search_v8_nolut_nosum",
        "v8_nolut_nosum",
    ),
    "v9": SystemSpec("v9", "v9", "gpu_search_v9", "v9"),
    "v8s8": SystemSpec("v8", "v8", "gpu_search_v8", "v8"),
    "v8s8_nosum": SystemSpec("v8_nosum", "v8_nosum", "gpu_search_v8_nosum", "v8_nosum"),
    "v8s8_nolut": SystemSpec("v8_nolut", "v8", "gpu_search_v8_nolut", "v8_nolut"),
    "v8s8_nolut_nosum": SystemSpec(
        "v8_nolut_nosum",
        "v8_nolut_nosum",
        "gpu_search_v8_nolut_nosum",
        "v8_nolut_nosum",
...
def validate_dataset_inputs(repo_root: Path, dataset: str) -> None:
    ...
    require_dir(repo_root / "dataset" / dataset / "gpu_mvr_2m")
...
def bench_command(
    ...
    cmd = [
        str(repo_root / "script" / "bench_gpu_mvr.sh"),
        "--dataset", dataset,
...
def parse_logs(repo_root: Path, log_run_dir: Path, dry_run: bool) -> None:
    if dry_run:
        return
    parser = repo_root / "script" / "parse_bench_logs.py"
    cmd = [sys.executable, str(parser), "--mode", "gpu-mvr", "--repo-root", str(repo_root), str(log_run_dir)]
