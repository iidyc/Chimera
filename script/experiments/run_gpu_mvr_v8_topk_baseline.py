...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Benchmark gpu_search_v8 with one query slot across dataset config sweeps. "
    ...
    parser.add_argument("--output-root", type=Path, default=repo_root / "profiling" / "gpu_mvr_v8_topk_baseline")
        ...
        for dataset in datasets:
            ...
            for config in configs:
                ...
                rows.append(run_gpu_search_direct(
                    ...
                    extra_row={"experiment": "v8_topk_baseline"},
                ))

    if args.dry_run:
        return 0

    results_csv = output_root / f"v8_topk_baseline_results_{args.run_id}.csv"
    summary_csv = output_root / f"v8_topk_baseline_summary_{args.run_id}.csv"
    preferred = [
