...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Path to the no-LUT v6 binary. Defaults to <build-dir>/gpu_search_v6_nolut."
        ),
    )
    parser.add_argument(
        "--datasets",
    ...
    parser.add_argument("--output-dir", type=Path, default=repo_root / "profiling" / "gpu_v6_lut_ablation")
