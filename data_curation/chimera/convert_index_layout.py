...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Convert legacy Chimera cpu_index.bin/gpu_index.bin outputs into the split doc_1bit/doc_4bit/cluster_1bit layout."
    )
